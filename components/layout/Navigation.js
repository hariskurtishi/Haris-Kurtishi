    ...
    <div className="sticky top-0 z-50 flex items-center bg-white selection:bg-orange-500 selection:text-white">
      <div className="container">
        <div className="justify-between py-5 row">
          ...
          >
            <ul className="flex-col w-full font-bold divide-y lg:flex text-orange-500 md:text-zinc-700 md:font-medium pt-14 lg:space-x-12 lg:w-auto md:p-0 md:flex-row lg:justify-center md:items-center lg:text-left md:divide-y-2 lg:divide-y-0 divide-orange-500 ">
